...

{
    ...
    loader.load('https://raw.githubusercontent.com/rayneong/p-final-npr-css/master/models/ucbugg_fox_epic.obj', (gltf) => {
	  var root = gltf;
		// var cup = root.getObjectByName('fox:fox_mesh');
	  var cup = root.getObjectByName('pCubeShape1_MASH1_Instancer_120');
	// var cup = root.getObjectByName('fox_mesh fox:fox_mesh');
